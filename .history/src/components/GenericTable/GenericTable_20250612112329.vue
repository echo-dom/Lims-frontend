            ...
            <div class="table-title">
                <el-row :gutter="10" class="mb8">
                    <el-col v-for="button in buttonlist" :span="1.5">
                        <el-button :disabled="button.disabled" :size="button.size" :loading="button.loading" :type="button.type" :plain="button.plain || true" :icon="button.icon" @click="button.onClick" v-hasPermi="[button.hasPermi]">
                            {{ button.label }}
                        </el-button>
                    </el-col>
                </el-row>
