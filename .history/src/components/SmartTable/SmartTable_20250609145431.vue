              ...
              <template #content>
                <div class="p-3">
                  ...
                  <div class="flex justify-end gap-2">
                    <el-button size="small" @click="() => $refs.popover[column.prop].hide()">取消</el-button>
...
import { ElTable, ElTableColumn, ElPagination, ElButton, ElInput, ElPopover, ElCheckbox, ElCheckboxGroup, ElDatePicker, ElSelect, ElOption, ElIcon, ElLoading } from 'element-plus'
...
const handleFilter = (prop) => {
  ...
  loadData()
  // 隐藏筛选框
  const popover = this.$refs.popover[prop]
  if (popover) {
    popover.hide()
  }
}
