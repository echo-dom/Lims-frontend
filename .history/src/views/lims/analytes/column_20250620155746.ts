...
const column = [
    { keyword:'', label: "排序号", prop: "sorter", width: "150" },
    { keyword:'', label: "分析项ID", prop: "analytesid", width: "150" },
    { keyword:'', label: "所属检测项目ID", prop: "testsid", width: "150",editable: true,editType:'text' },
    { keyword:'', label: "分析项目名称", prop: "analyte", width: "150",editable: true,editType:'text' },
