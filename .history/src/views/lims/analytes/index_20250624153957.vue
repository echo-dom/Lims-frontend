<template>
  <div style="height:calc(100vh - 84px); ">
    <GenericTable ref='GenericTable' :columnList="columnList" :buttonlist="buttons" :updateDataApi="updateAnalytes" :getDataApi="handleListAnalytes"
...
const GenericTable = ref(null)

const handleListAnalytes = (params)=>{
  params['testsid'] = props.id || null
  return listAnalytes(params)
}
