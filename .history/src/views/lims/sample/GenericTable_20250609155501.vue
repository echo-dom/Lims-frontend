                        ...
                        <div class="header-wrapper">
                            <div class="header-top">
                                ...
                                <span class="sort-icons">
                                    <i class="el-icon-caret-top" :class="{ 'is-active': sortProp === cloumn.prop && sortOrder === 'ascending' }" @click="sortChange(cloumn.prop, 'ascending')"></i>
                                    <i class="el-icon-caret-bottom" :class="{ 'is-active': sortProp === cloumn.prop && sortOrder === 'descending' }" @click="sortChange(cloumn.prop, 'descending')"></i>
                                </span>
...
watch(() => router.currentRoute.value.path, (toPath) => {}, { immediate: true, deep: true });
...
.header-text {
    ...
    white-space: nowrap;
    max-width: calc(100% - 40px); /* 为排序和过滤图标留出空间 */
    margin-right: 5px;
}
