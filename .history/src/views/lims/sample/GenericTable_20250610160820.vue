...
import { formatDateByYMD, getColumnTypeName } from './utils.ts';
...
// 缓存过滤结果
const filterCache = ref<Record<string, any[]>>({});
const buildFilter = (key: any) => {
    if (filterCache.value[key]) {
        return filterCache.value[key];
    }
