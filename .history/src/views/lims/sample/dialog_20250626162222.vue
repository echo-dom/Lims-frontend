            ...
            <el-card shadow="hover">
                ...
                <el-form :inline="true" :model="formInline" class="demo-form-inline">
                    <el-form-item label="选择客户">
                        <el-select v-model="value" multiple filterable remote reserve-keyword placeholder="请选择客户"
                            remote-show-suffix :remote-method="remoteMethod" :loading="loading2" style="width: 240px">
