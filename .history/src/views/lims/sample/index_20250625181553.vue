<template>
  <div class="report-sheet">
    ...
    <el-form :model="form" label-width="0" class="sheet-form">
      <el-row :gutter="20" v-for="(item, index) in form.items" :key="index">
        <el-col :span="12">
          <div class="form-box">
            <label class="form-label">{{ item.label }}</label>
            <el-input v-model="item.value" placeholder="请输入检测值" size="small">
        ...
        <el-col :span="12">
          <div class="form-box">
            ...
            <el-input v-model="item.ref" disabled size="small" />
          </div>
        </el-col>
      </el-row>
      ...
      <div class="form-box mt-4">
        ...
        <el-input type="textarea" v-model="form.remark" rows="3" size="small" />
      </div>
