          ...
          >
            <template #header>
              <div class="header-content-vertical">
                <!-- 上半部分：标题 + 排序/筛选图标，与标题紧密排列 -->
                <div class="header-top">
                  <div class="title-wrapper">
                    <span class="column-title" title="{{ col.label }}">{{ col.label }}</span>
                    <!-- 排序和过滤图标，依赖 Element Plus 默认触发区域 -->
                    <span class="icon-wrapper">
                      <i class="el-table__column-sort-trigger"></i>
                      <i class="el-table__column-filter-trigger"></i>
                    </span>
                  </div>
                </div>
                <!-- 下半部分：输入筛选框 -->
