            ...
            <el-card shadow="hover">
                ...
                <el-form :rules="rules" :inline="true" :model="formData" class="demo-form-inline" size="default"
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="8" >
                            <el-form-item label="要求完成时间" style="width: 100%;" required prop="inspectioncompletiondate">
                                <el-date-picker v-model="formData.inspectioncompletiondate" type="date"
                                    placeholder="Pick a date" clearable />
                            </el-form-item>
                        </el-col>
                        <el-col :span="8" style="display: flex;">
                            <el-form-item label-width="110px" style="width: 140px;" label="是否自编编号" prop="delivery">
                                <el-switch  v-model="formData.delivery" />
                            </el-form-item>
                             <el-form-item label-width="110px" style="margin-right:0" label="自编样品编号" required prop="sample_name" >
                                <el-input v-model="formData.sample_name" />
                            </el-form-item>
                        </el-col>
                    </el-row>
