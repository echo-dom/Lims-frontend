    ...
    <el-dialog width="80%" height="80%" fullscreen>
        ...
        <div style="height: calc(100vh - 150px);overflow: auto;">
            ...
            <el-card shadow="hover">
                ...
                <el-form :rules="rules" :inline="true" :model="formData" class="demo-form-inline">
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="样品名称" required prop="sample_name" style="width: 100%">
                                <el-input v-model="formData.sample_name" size="small"/>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="样品数量" required prop="sample_quantity" style="width: 100%">
                                <el-input v-model="formData.sample_quantity" size="small"/>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="样品批次" required prop="batch_number" style="width: 100%">
                                <el-input v-model="formData.batch_number" size="small"/>
                            </el-form-item>
                        </el-col>
                    </el-row>
