                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="8" style="display: flex;">
                            <el-form-item label-width="110px" style="width: 140px;" label="是否自编编号" >
                             ...
                             <el-form-item label-width="110px" style="margin-right:0" label="自编样品编号" :required="formData.manualy" prop="sample_name" >
                                <el-input :disabled="!formData.manualy" v-model="formData.sample_name" />
                            </el-form-item>
                        </el-col>
