    ...
    <el-dialog width="80%" height="80%" fullscreen>
        ...
        <div style="height: calc(100vh - 150px);overflow: auto;">
            ...
            <el-card shadow="hover">
                ...
                <el-form :rules="rules" :inline="true" :model="formData" class="demo-form-inline" size="default" label-width="155px" label-position="left">
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="样品名称" required prop="sample_name" style="width: 100%">
                                <el-input v-model="formData.sample_name" />
                            </el-form-item>
                        </el-col>
                        
                        <el-col :span="8">
                            <el-form-item label="测试周期" required style="width: 100%">
                                <el-select v-model="formData.customer"  placeholder="请选择测试周期"
                                    prop="customer" remote-show-suffix  >
                     ...
                     <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="选择客户" required style="width: 100%">
                                <el-select v-model="formData.customer" filterable remote reserve-keyword placeholder="请选择客户"
                                    prop="customer" remote-show-suffix :remote-method="remoteMethod" :loading="loading2"
                        ...
                        <el-col :span="8">
                            <el-form-item label="选择合同" required style="width: 100%">
                                <el-select v-model="formData.customer" filterable remote reserve-keyword placeholder="请选择合同"
                                    prop="customer" remote-show-suffix :remote-method="remoteMethod" :loading="loading2"
                                    @change="changeCustomer" >
                                    <el-option v-for="item in options" :key="item.compcode" :label="item.label"
                                        :value="item.compcode" />
                        ...
                        <el-col :span="8">
                            <el-form-item label="地址编码" required prop="ccode" style="width: 100%">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="14" style="display: flex;">
                            <el-form-item label="样品数量" required prop="sample_quantity" style="width: 100%">
                                 <el-input-number v-model="formData.sample_quantity" :min="1"  />
                            </el-form-item>
                             <el-form-item label="样品批次" required prop="batch_number" style="width: 100%">
                    ...
                    <el-form-item label="榨季阶段" required>
                        <el-select v-model="formData.grindingseason" filterable  reserve-keyword placeholder="请选择"
                            prop="grindingseason"  
                            >
                            <el-option v-for="item in grindingseasonOption" :key="item.value" :label="item.label"
                                :value="item.value" />
                        </el-select>
                    </el-form-item>
                </el-form>
