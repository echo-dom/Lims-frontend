    ...
    <el-container class="container">】
            ...
            <el-dropdown trigger="click">
                ...
                <template #dropdown>
                    <el-checkbox-group v-model="selectedColumns">
                        <el-checkbox v-for="column in columnList" :key="column.prop" :label="column.prop">{{ column.label }}</el-checkbox>
                    </el-checkbox-group>
                </template>
            </el-dropdown>
        ...
        <el-config-provider :locale="locale">
            <el-table 
                ...
                <!-- 使用 visibleColumns 动态渲染列 -->
                <el-table-column v-for="cloumn in visibleColumns" :key="cloumn.prop" align="center" show-overflow-tooltip
