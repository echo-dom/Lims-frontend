            ...
            <el-card shadow="hover">
                ...
                <el-form :rules="rules" :inline="true" :model="formData" class="demo-form-inline" size="default"
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="8" style="display: flex;">
                            <el-form-item label-width="110px" label="是否自编编号" prop="delivery">
                                <el-switch style="width: 40px;" v-model="formData.delivery" />
                            </el-form-item>
                             <el-form-item label-width="110px" label="自编样品编号" required prop="sample_name" >
                                <el-input v-model="formData.sample_name" />
                            </el-form-item>
                        </el-col>
                    </el-row>
