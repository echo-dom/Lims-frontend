<template>
  <div style="height:calc(100vh - 84px); ">
    ...
    <GenericVirtualTable :columnList="columnList" :buttonlist="buttons" :updateDataApi="updateTests" :getDataApi="listTests"
      @handleSelectionChange="handleSelectionChange" @dataLoaded="onDataLoaded" />
...
import GenericVirtualTable from '@/components/GenericTable/GenericVirtualTable.vue'
