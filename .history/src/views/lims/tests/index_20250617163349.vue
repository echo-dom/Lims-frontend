  ...
  <div style="height:calc(100vh - 84px); ">
    <el-splitter>
      <el-splitter-panel collapsible min="50">
        <GenericTable :columnList="columnList" :buttonlist="buttons" :updateDataApi="updateTests"
          :getDataApi="listTests" @handleSelectionChange="handleSelectionChange" @dataLoaded="onDataLoaded" />
      </el-splitter-panel>
